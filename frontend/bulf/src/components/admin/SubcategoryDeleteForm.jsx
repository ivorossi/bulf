...
const DeleteSubcategoryForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`http://localhost:8080/api/auth/admin/subcategory/${selectedSubcategoryId}`, {
                method: 'DELETE',
                headers: {
    ...
    return (
        <form className="form-container" onSubmit={handleSubmit}>
            ...
            <div className="form-group">
                <label htmlFor="subcategory">Seleccionar Subcategoría:</label>
                <select
                    id="subcategory"
