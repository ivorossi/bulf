...
const AdminPanel = () => {
  ...
  const [isCategoryDeleteFormOpen, SetIsCategoryDeleteFormOpen] =
    useState(false);
  const [isSubcategoryFormOpen, setIsSubcategoryFormOpen] = useState(false);
  const [isSubcategoryDeleteFormOpen, setIsSubcategoryDeleteFormOpen] =
    useState(false);
  ...
  return (
    <div>
      ...
      <div className="admin-buttons">
        <button className="admin-button" onClick={toggleGenderFormModal}>
          Add Gender
        </button>
        <button className="admin-button" onClick={toggleCategoryFormModal}>
          Add Category
        </button>
        <button className="admin-button" onClick={toggleSubcategoryFormModal}>
          Add Subcategory
        </button>
        <button className="admin-button" onClick={toggleProductFormModal}>
          Add Product
        </button>
      </div>

      <div className="admin-delete-buttons">
        <button className="delete-button" onClick={handleDeleteGender}>
          Delete Gender
        </button>
        <button className="delete-button" onClick={handleDeleteCategory}>
          Delete Category
        </button>
        <button className="delete-button" onClick={handleDeleteSubcategory}>
          Delete Subcategory
        </button>
        <button className="admin-button" onClick={handlePurchaseOrders}>
          Purchases Orders
        </button>
      </div>
      ...
      >
        <button onClick={toggleGenderFormModal} className="close-modal">
          X
        </button>
        <GenderForm />
      </Modal>
      <Modal
        ...
        overlayClassName="modal-overlay"
      >
        <button onClick={handleDeleteGender} className="close-modal">
          X
        </button>
        <GenderDeleteForm />
      </Modal>
      ...
      <Modal
        ...
        overlayClassName="modal-overlay"
      >
        <button onClick={toggleCategoryFormModal} className="close-modal">
          X
        </button>
        <CategoryForm />
      </Modal>
      ...
      <Modal
        ...
        overlayClassName="modal-overlay"
      >
        <button onClick={handleDeleteCategory} className="close-modal">
          X
        </button>
        <CategoryDeleteForm />
      </Modal>
      ...
      <Modal
        ...
        overlayClassName="modal-overlay"
      >
        <button onClick={toggleSubcategoryFormModal} className="close-modal">
          X
        </button>
        <SubcategoryForm />
      </Modal>
      ...
      <Modal
        ...
        overlayClassName="modal-overlay"
      >
        <button onClick={handleDeleteSubcategory} className="close-modal">
          X
        </button>
      ...
      <Modal
        ...
        overlayClassName="modal-overlay"
      >
        <button onClick={toggleProductFormModal} className="close-modal">
          X
        </button>
        <ProductForm />
      </Modal>
